...
- Enhanced development mode with graceful MongoDB connection handling
- Added SKIP_MONGODB=true option for testing without a database
...
If you don't have MongoDB installed or just want to test the frontend features:
...
This will run the application with limited functionality, allowing you to test the UI and real-time features without a database connection.
